...
**A ARTE recomenda que os dados estejam alojados nos sistemas das entidades fornecedoras, seja através de ficheiros, serviços ou portais de dados, sem nessidade de os duplicar no dados.gov. Neste cenário, o portal nacional indexa apenas a metainformação dos dados e não os dados em si (aponta apenas para os dados)**.
...
Nalguns casos, em que exista já outro tipo de catálogo, a equipa da ARTE poderá estudar o desenvolvimento de um _harvester_ à medida.
