...
É desenvolvido e gerido pela Agência para a Reforma Tecnológica do Estado (ARTE), que prossegue as atribuições da Presidência do Conselho de Ministros nas áreas da modernização e simplificação administrativa e da administração eletrónica. A utilização da plataforma dados.gov.pt está subordinada à aceitação dos presentes termos e condições de utilização (TCU).
...
A ARTE propõe dois tipos de certificação a nível de organizações:
...
A Lei n.º 68/2021, que transpõe a Diretiva (EU) 2019/1024, concerne ao portal dados.gov, o papel de representar o Catálogo Central de Dados Abertos em Portugal.

Neste sentido, o dados.gov tem a função de: Agregar, Referenciar, Publicar e Alojar dados abertos de diferentes organismos e setores da Administração Pública Central, Regional e Local; bem como ser um indexador de conteúdos alojados noutros portais ou catálogos de dados abertos.

É da responsabilidade de quem publica (Entidades e outros Utilizadores do portal):
* Cumprir o disposto na Lei n.º 68/2021;
* Cumprir o RGPD;
* Publicar conjuntos de dados abertos de qualidade;
* Associar metadados de qualidade;
* Garantir o nível de atualização dos dados e dos metadados;
* Assegurar que não existem vírus, malware, código malicioso ou quaisquer outros elementos que possam comprometer a integridade, segurança ou funcionamento do portal e dos seus utilizadores.<br>
<br>

Em caso de deteção de qualquer tipo de situação anómala, a ARTE poderá, sem necessidade de pré-aviso, suspender ou remover o acesso a quaisquer conjuntos de dados que tenham sido carregados no dados.gov.pt.
...
O Participante é responsável pelos conjuntos de dados que publica no dados.gov.pt, e deve assegurar-se que essa publicação está conforme a legislação em vigor. Caso existam dados pessoais num determinado conjunto de dados, a ARTE aconselha a que o facto seja referido na documentação do respetivo conjunto, e que sejam mencionadas – caso existam – quaisquer restrições jurídicas à sua reutilização.
...
## Deveres e responsabilidades da ARTE

### Qualidade do serviço

A ARTE esforçar-se-á para garantir uma disponibilidade de 99,5% mensal da plataforma, de acordo com os meses do calendário.

A ARTE oferece a possibilidade de contribuir a aceder à plataforma através de uma interface web ou de uma interface de programação (API).

A ARTE deverá garantir as melhores condições para preservar a integridade e disponibilização dos conjuntos de dados. Reserva-se também a possibilidade de alterar ou acrescentar a metainformação associada a conjuntos de dados, quando considerar que essa alteração é benéfica para o utilizador.

A ARTE reserva-se a liberdade de evoluir, modificar ou suspender, sem pré-aviso, o dados gov por motivos de manutenção ou outra razão que considere necessária. A indisponibilidade da plataforma não dá direito a nenhuma indemnização.

### Responsabilidades da ARTE

A ARTE tem a responsabilidade de produção e gestão de conteúdo da plataforma.

A ARTE não efetua um controlo *a priori* das publicações efetuadas pelos organismos públicos ou os participantes do dados.gov.pt. Sempre que forem detetadas situações irregulares ou em não-conformidade com estes TCU, a ARTE agirá rapidamente para remover esses dados ou tornar impossível o seu acesso. Para este efeito, os utilizadores da plataforma também poderão sinalizar conteúdos que considerem problemáticos, sendo que caberá a ARTE a decisão final sobre a necessidade, ou não, de intervenção.
...
### Conteúdos criados pela ARTE

Os conteúdos criados pela ARTE são publicados ao abrigo da licença CC BY 4.0, podendo ser reutilizados para quaisquer fins. Excetuam-se representações iconográficas e fotográficas, que estão abrangidas por licenças próprias.
...
Estes TCU poderão ser alterados a qualquer momento, sem pré-aviso, em função de alterações na plataforma, regulatórias ou por motivos considerados necessários pela ARTE.
...
O registo na plataforma necessita que o utilizador forneça à ARTE as informações relativas a “nome”, “apelido” e “e-mail”. A ARTE compromete-se a garantir a segurança e confidencialidade dos e-mails dos utilizadores, não partilhando essa informação com terceiros.
...
O histórico de navegação do utilizador não é disponibilizado publicamente, sendo apenas divulgado pela ARTE nos casos previstos por lei.
...
Os dados pessoais são recolhidos e tratados para permitir à ARTE a gestão de utilizadores e de acessos ao portal.
...
A entidade responsável pela recolha e tratamento dos dados pessoais é a Agência para a Reforma Tecnológica do Estado.
